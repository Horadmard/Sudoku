...
def generate_new_solution(*, org_sudoku: list, cur_sudoku: list) -> list:
    ...
    while element_row == element_row_new and element_col == element_col_new:
    ...
    while org_sudoku[actual_row][actual_col] != 0 or org_sudoku[actual_row_new][actual_col_new] != 0:
